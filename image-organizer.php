				...
				<form class="io-upload-form" enctype="multipart/form-data">
					...
					<div class="io-upload-row">
						...
						<p class="io-upload-help">
							...
							printf(
								esc_html__( 'Max size: %dMB. Allowed: JPG, PNG, GIF, WebP.', 'image-organizer' ),
								(int) $upload_max_mb
							);
							?>
						</p>
					...
					<div class="io-upload-row">
						<label class="io-upload-label" for="<?php echo esc_attr( $gallery_id ); ?>-upload-title"><?php esc_html_e( 'Title', 'image-organizer' ); ?></label>
						<input id="<?php echo esc_attr( $gallery_id ); ?>-upload-title" class="io-upload-title-input" type="text" name="io_title" />
					</div>

					<div class="io-upload-row">
						<label class="io-upload-label" for="<?php echo esc_attr( $gallery_id ); ?>-upload-desc"><?php esc_html_e( 'Description', 'image-organizer' ); ?></label>
						<textarea id="<?php echo esc_attr( $gallery_id ); ?>-upload-desc" class="io-upload-desc" name="io_description" rows="3"></textarea>
					</div>

					<div class="io-upload-row">
						<label class="io-upload-label" for="<?php echo esc_attr( $gallery_id ); ?>-upload-alt"><?php esc_html_e( 'Alt text', 'image-organizer' ); ?></label>
						<input id="<?php echo esc_attr( $gallery_id ); ?>-upload-alt" class="io-upload-alt" type="text" name="io_alt" />
					</div>

					<?php if ( ! empty( $upload_key_required ) ) : ?>
						<div class="io-upload-row">
							<label class="io-upload-label" for="<?php echo esc_attr( $gallery_id ); ?>-upload-key"><?php esc_html_e( 'Upload key', 'image-organizer' ); ?></label>
							<input id="<?php echo esc_attr( $gallery_id ); ?>-upload-key" class="io-upload-key" type="password" name="io_upload_key" required />
						</div>
					<?php endif; ?>
					...
					<div class="io-upload-hp" aria-hidden="true">
						...
						<input id="<?php echo esc_attr( $gallery_id ); ?>-website" type="text" name="website" tabindex="-1" autocomplete="off" />
					</div>
