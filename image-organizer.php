...
class Image_Organizer_Gallery
{
   ...
   * ThemeIsle Media Library Organizer uses 'mlo_category' for attachments.
   */
  const MLO_TAXONOMY = 'mlo-category';
  ...
  public function register_taxonomies()
  {
    ...
    if (taxonomy_exists(self::MLO_TAXONOMY)) {
      register_taxonomy_for_object_type(self::MLO_TAXONOMY, 'attachment');
    }
  }
  ...
  public function render_gallery_shortcode($atts)
  {
    ...
    error_log('IO final query vars: ' . print_r($query->query_vars, true));
    error_log('IO found posts count: ' . (int) $query->found_posts);
